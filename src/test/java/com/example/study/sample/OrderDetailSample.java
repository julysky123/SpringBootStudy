...
public class OrderDetailSample{
    ...
    private void item(User user){
        ...
        OrderStatus status = OrderStatus.HOLDING;
        ...
        for(Item item : items){
            ...
            OrderStatus orderDetailStatus = OrderStatus.HOLDING;
            switch (random.nextInt(3)+1){
                case 1 :
                    orderDetailStatus = OrderStatus.HOLDING;
                    break;

                case 2 :
                    orderDetailStatus = OrderStatus.ONGOING;
                    break;
